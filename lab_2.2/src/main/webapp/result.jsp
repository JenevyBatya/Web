...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
      <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/src/css/Stylesheet.css">

</head>
<body>
<%--<jsp:include page="temp.jsp">--%>
<script type="module" src="${pageContext.request.contextPath}/src/js/result.js"></script>
...
<%--    link.rel = 'stylesheet';--%>
<%--    link.type = 'text/css';--%>
<%--    link.href = './src/css/Stylesheet.css'; // Путь к вашему CSS файлу--%>
